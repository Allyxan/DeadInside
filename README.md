...
| ПП (Программист) | 2 контроль | Разрабатывает процедуры - обработчики и генераторы тестовых наборов данных | JS- и PHP-модули |
| ПП (Программист) | 3 финиш | Разрабатывает и отлаживает процедуры - генераторы тестовых наборов данных | JS- и PHP-модули | 
